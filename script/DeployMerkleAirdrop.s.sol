...
contract DeployMerkleAirdrop is Script {
    ...
    uint256 public AMOUNT_TO_TRANSFER = 4 * (25 * 1e18); //we have multiplied by 4 as there are 4 people in our example list
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, BagelToken) {
        ...
        //here we mint tokens needed to be airdropped to the deployer
